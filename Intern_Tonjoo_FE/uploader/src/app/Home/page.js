...
export default function Home() {
  return (
    <div className="bg-white rounded-lg shadow p-8 max-w-4xl mx-auto">
      <h2 className="text-3xl font-bold mb-4 text-center font-sans">Image Re-Uploader</h2>
        ...
        <div className="bg-gray-300 rounded-lg shadow p-8 w-full  mx-auto">
          <div className="bg-gray-100 p-4 rounded-lg mb-6">
            <ul className="flex border-b">
              <li className="mr-1">
                <Link
                  className="inline-block py-2 px-4 text-blue-500 font-semibold bg-primary hover:text-white"
                  href="/"
                >
                  Input Text
                </Link>
              ...
              <li className="mr-1">
              <Link className="inline-block py-2 px-4 text-blue-500 hover:text-blue-800 hover:bg-primary hover:text-white "
              ...
              <li className="mr-1">
                <a
                  className="inline-block py-2 px-4 text-blue-500 hover:text-blue-800 hover:bg-primary hover:text-white "
                  href="#"
                >
                  URL List
                </a>
